...
<body>
	<table>
		<tr>
			<td width="10%">
			<img src="<?php echo base_url(); ?>aset/img/ma'arif.png" style="margin-top: 10px; margin-left: 5px; width: 90px; height: 70px">
			</td>
			<td style="text-align: center"><b>KEMENTERIAN AGAMA REPUBLIK INDONESIA<br>
			KANTOR KEMENTERIAN AGAMA KABUPATEN PEKALONGAN<br>
			...
			Telp : 0285 4232 71 | Web : http://www.smpwhpekalongan.sch.id</span>
			</td>
		</tr>
	...
	<div style="margin-left: 120px; display: inline; float: left;">
		Pekalongan, <?php echo tjs($ds['diterima_tgl'],"l"); ?><br>
		Kepala Madrasah<br>
		<br>
		<br>
		<br>
		<br>
		<b><u>Hj. Shofianah, S.Pd</u></b><br>
	</div>
