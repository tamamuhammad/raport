	...
	<table>
		...
		<tbody>
			...
			<tr>
				...
				<td width="1%">:</td>
				<td width="39%" class="tbl"><?php echo $this->config->item('nama_sekolah'); ?></td>
				<td width="20%">Kelas</td>
				<td width="1%">:</td>
				<td width="19%" class="tbl"><?php echo strtoupper($wali_kelas['nmkelas']); ?></td>
			</tr>
			<tr>
				<td>Alamat Madrasah</td>
				<td>:</td>
				<td class="tbl"><?php echo $this->config->item('alamat_sekolah'); ?></td>
				<td>Semester</td>
				<td>:</td>
				<td class="tbl"><?php echo $semester; ?></td>
			</tr>
			<tr>
				<td>Nama Siswa</td>
				<td>:</td>
				<td class="tbl"><?php echo $det_siswa['nama']; ?></td>
				<td>Tahun Pelajaran</td>
				<td>:</td>
				<td class="tbl"><?php echo $ta; ?></td>
			</tr>
			<tr>
				<td>NIS / NISN</td>
				<td>:</td>
				<td class="tbl"><?php echo $det_siswa['nis'] . " / " . $det_siswa['nisn']; ?></td>
				<td colspan="3"></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="6">
					<table style="margin-left: 15px">
						...
						<tr>
							<td></td>
							<td style="border: solid 1px #000; padding: 10px">Deskripsi : <?php echo $nilai_sikap_spiritual; ?></td>
						</tr>
						<tr>
							<td width="3%"><b>2.</b></td>
						...
						<tr>
							<td></td>
							<td style="border: solid 1px #000; padding: 10px">Deskripsi : <?php echo $nilai_sikap_sosial; ?></td>
						</tr>
					</table>
				</td>
			</tr>
			<tr>
				<td colspan="6"><b>B. Pengetahuan dan Keterampilan<br>&nbsp;&emsp;Kriteria Ketuntasan Minimal (KKM): <?= $kkm['kkm']; ?></b></td>
			</tr>
			<tr>
				<td colspan="6">
					<table class="table">
						<thead>
							<tr>
								<th colspan="2" rowspan="2" width="40%">Mata Pelajaran</th>
							...
							<td width="40%">
								<table class="table" width="100%">
									<tr>
										...
										<td width="40%" class="ctr"><?php echo $nilai_absensi['s']; ?> &nbsp; hari</td>
									</tr>
									<tr>
										<td>Izin</td>
										<td class="ctr"><?php echo $nilai_absensi['i']; ?> &nbsp; hari</td>
									</tr>
									<tr>
										<td>Tanpa Keterangan</td>
										<td class="ctr"><?php echo $nilai_absensi['a']; ?> &nbsp; hari</td>
									</tr>
								</table>
							</td>
							<td width="60%">
