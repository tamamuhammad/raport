...
class Cetak_raport extends CI_Controller
{
    ...
    public function cetak($id_siswa, $tasm)
    {
        ...
        $d['kkm'] = $this->db->get_where('t_kkm', ['kelas' => $d['wali_kelas']['tingkat']])->row_array();
        ...
        //     $d['nilai_utama'] .= '<tr><td class="ctr">' . $no . '</td><td colspan="8">Pendidikan Agama Islam & Budi Pekerti</td></tr>';
        ...
        //no pai kelompok A
        $no++;
        $q_mapel = $this->db->query("SELECT * FROM m_mapel WHERE kelompok = 'A'")->result_array();
        ...
        $d['nilai_utama'] .= '<tr><td class="ctr">' . $no++ . '</td><td>Muatan Lokal</td></tr>';
        ...
        $d['nilai_utama'] .= '<tr><td colspan="8"><b>KELOMPOK C</b></td></tr>';
        $q_mapel = $this->db->query("SELECT * FROM m_mapel WHERE kelompok = 'C'")->result_array();
        ...
        $d['nilai_kedua'] .= '<tr><td colspan="8"><b>KELOMPOK A</b></td></tr>';
        $no = 1;
        ...
        //no pai kelompok B
        $d['nilai_kedua'] .= '<tr><td colspan="8"><b>KELOMPOK B</b></td></tr>';
        $q_mapel = $this->db->query("SELECT * FROM m_mapel WHERE kelompok = 'B' AND tambahan_sub = 'NO'")->result_array();
        ...
        $d['nilai_kedua'] .= '<tr><td class="ctr">' . $no++ . '</td><td>Muatan Lokal</td></tr>';
        $q_mapel = $this->db->query("SELECT * FROM m_mapel WHERE kelompok = 'B' AND tambahan_sub = 'MULOK'")->result_array();
        ...
        $d['nilai_kedua'] .= '<tr><td colspan="8"><b>KELOMPOK C</b></td></tr>';
        $q_mapel = $this->db->query("SELECT * FROM m_mapel WHERE kelompok = 'C'")->result_array();
