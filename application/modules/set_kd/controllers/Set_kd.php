...
class Set_kd extends CI_Controller
{
    ...
    public function datatable($id)
    {
        ...
        foreach ($q_datanya as $d) {
            ...
            $data_ok[4] = '<a href="#" onclick="return edit(\'' . $d['id'] . '\');" class="btn btn-xs btn-success"><i class="fa fa-edit"></i> Edit</a> <a href="#" onclick="return hapus(\'' . $d['id'] . '\');" class="btn btn-xs btn-danger"><i class="fad fa-trash"></i> Hapus</a> ';
