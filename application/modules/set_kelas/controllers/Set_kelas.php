...
class Set_kelas extends CI_Controller
{
    ...
    public function datatable()
    {
        ...
        foreach ($q_datanya as $d) {
            ...
            $data_ok[3] = '<a href="#" onclick="return hapus(\'' . $d['id'] . '\');" class="btn btn-xs btn-danger"><i class="fad fa-eraser"></i> Hapus</a> ';
            ...
            foreach ($ambil_data_kelas as $v) {
                ...
                if (!empty($q_siswa_per_kelas)) {
                    ...
                    foreach ($q_siswa_per_kelas as $k) {
                        $tampil .= '<tr><td>' . $no++ . '</td><td>' . $k['nmsiswa'] . '</td><td class="ctr"><a href="#" onclick="return hapus(' . $k['id'] . ');" class="btn btn-danger btn-xs"><i class="fad fa-eraser"></i></a></td></tr>';
                    }
                }
