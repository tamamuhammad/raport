...
class Data_guru extends CI_Controller
{
    ...
    public function datatable()
    {
        ...
        foreach ($q_datanya as $d) {
            ...
            $link_aktif_user = $d['jml_aktif'] > 0 ? '<a href="#" onclick="return nonaktifkan(\'' . $d['id'] . '\');" class="btn btn-xs btn-warning"><i class="fad fa-user"></i> NonAktifkan User</a>' : '<a href="#" onclick="return aktifkan(\'' . $d['id'] . '\');" class="btn btn-xs btn-info"><i class="fad fa-user"></i> Aktifkan User</a>';

            $data_ok[4] = '<a href="#" onclick="return edit(\'' . $d['id'] . '\');" class="btn btn-xs btn-success"><i class="fa fa-edit"></i> Edit</a> 
                <a href="#" onclick="return hapus(\'' . $d['id'] . '\');" class="btn btn-xs btn-danger"><i class="fad fa-trash"></i> Hapus</a> ' . $link_aktif_user;
