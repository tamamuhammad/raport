<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h4 class="title">Upload Data NP : <?php echo $bawa['nmmapel'] . ", Kelas: " . $bawa['nmkelas'] . ", Guru: " . $bawa['nmguru']; ?></h4>
            ...
            <div class="content">
                ...
                <form method="post" id="<?php echo $nama_form; ?>" name="<?php echo $nama_form; ?>" action="<?php echo base_url() . $url; ?>/import_nilai" enctype="multipart/form-data">
                    ...
                    <p>
                        ...
                        <a href="<?php echo base_url() . $url . "/index/" . $bawa['id']; ?>" class="btn btn-danger">Kembali</a>
