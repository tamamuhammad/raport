    ...
    <div class="col-md-12">
        <div class="alert alert-warning" style="color: #000">
            ...
            <ul>
                ...
                <li>Jika kompetensi dasar belum ada, silakan klik tombol <b><i>Tambah KD</i></b>. Untuk mengubah atau menghapus nama KD, silakan klik tombol "<i class="fa fa-pencil"></i>" atau "<i class="fad fa-trash"></i>". </li>
            ...
            success: function(data) {
                ...
                if (data.length > 0) {
                    $.each(data, function(i, v) {
                        h += '<li class="list-group-item"><a href="#" onclick="return view_kd(' + v.id + ', <?= $detil_mp['id_kelas']; ?>);">(' + v.no_kd + ') ' + v.nama_kd + '</a><div class="pull-right"><a href="#" onclick="return edit(' + v.id + ');" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i> </a><a href="#" onclick="return hapus(' + v.id + ');" class="btn btn-xs btn-danger"><i class="fad fa-trash"></i> </a></div></li>';
                    });
                } else {
