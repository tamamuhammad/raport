...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>aset/plugins/fontawesome/css/all.min.css">
...
<body>
    ...
    -->
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="https://blogbugabagi.blogspot.com" target="_blank" class="simple-text">
                        <i class="fad fa-book-open"></i> E-RAPORT K13
                    </a>
                </div>
                <ul class="nav">
                    <?php
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            ?>
                                ...
                                <li style="border-left: 1px solid #d9d6d0">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <p class="copyright pull-left">
                        <b><?php echo $this->config->item('nama_sekolah'); ?> </a></b>
                    </p>
